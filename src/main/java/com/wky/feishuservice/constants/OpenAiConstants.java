...
public class OpenAiConstants {
    ...
    public static String PREDICT_QUESTION_PROMPT ="我想让你作为一个OpenAI助手，帮助根据给定的上下文预测用户可能提出的下一个问题。请确保所有的回答使用中文。如果有多个可能的问题，请使用空格隔开，且最多提供3个预测。如果检测到用户可能不会再提问，则仅返回“无”。请注意，返回结果应严格按照指定格式，如“java有什么优势 java相比其他语言有什么优点”或“无”，不要包含任何其他多余的文字或标点符号。";
}
